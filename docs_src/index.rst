.. markdown_to_mrkdwn documentation master file
...
.. list-table::
   ...
   * - `---`
     - `──────────`
   * - Tables
     - Simple text tables with bold headers
...
If an error occurs during conversion, the original markdown text will be returned.
